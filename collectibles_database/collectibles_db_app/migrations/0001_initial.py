    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gradation_system', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='value', to='collectibles_db_app.gradationsystem', verbose_name='gradation_system')),
            ],
            options={
                'verbose_name': 'value',
